...
<?php
	...
	include('assets/inc/config.php');
		if(isset($_POST['update_patient']))
		{
			...
			$query="UPDATE   login_patient  SET Fname=?, Lname=?, pat_age=?, pat_dob=?, pat_number=?, Phone=?, pat_addr=?,pat_type=? WHERE id = ?";
			$stmt = $mysqli->prepare($query);
			$rc=$stmt->bind_param('ssssssssi', $Fname, $Lname, $pat_age, $pat_dob, $pat_number, $Phone, $pat_addr,$pat_type, $id);
			$stmt->execute();
			/*

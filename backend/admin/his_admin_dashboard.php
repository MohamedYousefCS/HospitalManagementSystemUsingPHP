                                        ...
                                        <div class="col-6">
                                            <div class="text-right">
                                                <?php
                                                    ...
                                                    $result ="SELECT count(*) FROM login_patient WHERE pat_type = 'OutPatient' ";
                                                ...
                                                <p class="text-muted mb-1 text-truncate">مرضي الخروج </p>
                                            </div>
                                        </div>
                                    </div> <!-- end row-->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="text-right">
                                                ...
                                                <p class="text-muted mb-1 text-truncate">هيئة العمل</p>
                                            </div>
                                        </div>
                                    </div> <!-- end row-->
                                </div> <!-- end widget-rounded-circle-->
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td style="width: 36px;" colspan="2">
                                                        <img class="mx-auto rounded-circle avatar-sm" src="../doc/assets/images/users/<?php echo $row->doc_dpic;?>" alt="img" title="contact-img"  />
                                                    </td>

...
<?php
	...
	include('assets/inc/config.php');
		if(isset($_POST['add_doc']))
		{
			...
			$query="INSERT INTO his_docs (doc_fname, doc_lname, doc_number, doc_email,docFees, doc_pwd) values(?,?,?,?,?,?)";
			$stmt = $mysqli->prepare($query);
			$rc=$stmt->bind_param('ssssss', $doc_fname, $doc_lname, $doc_number, $doc_email,$docFees, $doc_pwd);
			$stmt->execute();
			/*
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form method="post">
                                            ...
                                            <div class="form-group ">
                                            <label for="inputAddress" class="col-form-label">Doctor Fees</label>
                                            <select class="form-select" name="docFees" aria-label="Default select example">

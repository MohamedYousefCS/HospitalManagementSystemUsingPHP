...
<?php
	...
	include('assets/inc/config.php');
		if(isset($_POST['add_doc']))
		{
			...
			$query="INSERT INTO his_pharms (doc_fname, doc_lname, doc_number, doc_email, doc_pwd,doc_dept) values(?,?,?,?,?,?)";
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Add pharmacist Details</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="post">
                                            ...
                                            <div class="form-group col-md-2" style="display:none">
                                                    ...
                                                    ?>
                                                    <label for="inputZip" class="col-form-label">pharmacist Number</label>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select id="inputState" required="required" name="doc_dept" class="form-control">
                                                    <option abled selected>Pharmacist</option>
                                                
                                                    </select>
                                            </div>

                                            <button type="submit" name="add_doc" class="ladda-button btn btn-success" data-style="expand-right">Add pharmacist</button>

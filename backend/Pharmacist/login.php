<?php
    ...
    if(isset($_POST['doc_login']))
    {
        ...
        $stmt=$mysqli->prepare("SELECT doc_number, doc_pwd, doc_id FROM his_pharms WHERE  doc_number=? AND doc_pwd=? ");//sql to log in user
        ...
        if($rs)
            {//if its sucessfull
                header("location:his_pharm_dashboard.php");
            }
      ...
      <div class="text-center">
        ...
        <div class="row d-flex justify-content-center align-items-center h-100">
          <div class="col-md-9 col-lg-6 col-xl-5">
             <!-- https://cdni.iconscout.com/illustration/premium/thumb/hospital-and-medical-assistants-and-ambulance-2681143-2233471.png -->
            <img
              src="assets/images/pharm.webp"
              class="img-fluid"
              alt="Sample image"
            />
          </div>

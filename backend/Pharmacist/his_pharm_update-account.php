	...
	include('assets/inc/config.php');
		if(isset($_POST['update_profile']))
		{
           ...
           // $doc_pwd=sha1(md5($_POST['doc_pwd']));
			...
			$query="UPDATE his_pharms SET doc_fname=?, doc_lname=?,  doc_email=?, doc_dpic=? WHERE doc_id = ?";
        ...
        if(isset($_POST['update_pwd']))
		{
            ...
            //sql to insert captured values
			$query="UPDATE his_pharms SET doc_pwd =? WHERE doc_number = ?";
			$stmt = $mysqli->prepare($query);
...
<!DOCTYPE html>
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <?php
                $doc_id=$_SESSION['doc_id'];
                $ret="SELECT * FROM  his_pharms where doc_id=?";

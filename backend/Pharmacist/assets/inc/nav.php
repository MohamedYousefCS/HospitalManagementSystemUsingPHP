<?php
    ...
    $ret="SELECT * FROM  his_pharms WHERE doc_id = ? AND doc_number = ?";
        ...
        <ul class="list-unstyled topnav-menu float-right mb-0">
            ...
            <li class="dropdown notification-list">
                ...
                <div class="dropdown-menu dropdown-menu-right profile-dropdown ">
                    ...
                    <a href="his_pharm_update-account.php" class="dropdown-item notify-item">
                    ...
                    <!-- item-->
                    <a href="his_pharm_logout_partial.php" class="dropdown-item notify-item">

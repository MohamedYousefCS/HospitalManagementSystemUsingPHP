                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="page-title-box">
                                        ...
                                        <h4 class="page-title">Capture <?php echo $row->Fname;?> <?php echo $row->Lname;?> Vitals</h4>
                                    </div>
                                </div>
                            </div>     
                            <!-- end page title --> 
                                            ...
                                            <form method="post">
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-12">
                                                        ...
                                                        <input type="text" required="required" readonly name="" value="<?php echo $row->Fname;?> <?php echo $row->Lname;?>" class="form-control" id="inputEmail4" placeholder="Patient's First Name">
                                                    </div>

                ...
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">HMS Dashboard</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                        ...
                                        <div class="col-6">
                                            <div class="text-right">
                                                <?php
                                                    ...
                                                    $result ="SELECT count(*) FROM login_patient  ";
                        ...
                        <!--Start Vendors-->
                            ...
                            <div class="col">
                                <a href="his_laboratory_account.php">
                                    <div class="widget-rounded-circle card-box">
                                        <div class="row">
                                            <div class="col-6">
                                                <div class="avatar-lg rounded-circle bg-soft-danger border-danger border">
                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="card-box">
                                    <h4 class="header-title mb-3 text-right">المرضى</h4>

                                    <div class="table-responsive">
                                        <table dir="rtl" class="table table-borderless table-hover table-centered m-0">
                                            ...
                                            <?php
                                                $ret="SELECT * FROM login_patient ORDER BY RAND() LIMIT 100 "; 
                                                //sql code to get to ten laps  randomly
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="his_lap_view_single_patient.php?pat_id=<?php echo $row->id;?>&&pat_number=<?php echo $row->pat_number;?>&&pat_name=<?php echo $row->Fname;?>_<?php echo $row->Lname;?>" class="btn btn-xs btn-success"><i class="mdi mdi-eye"></i> View</a>
                                                    </td>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   
                                                </tr>
                                            </tbody>
                                            <?php }?>

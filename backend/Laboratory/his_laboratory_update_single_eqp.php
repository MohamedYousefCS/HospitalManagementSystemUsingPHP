...
<?php
	...
	include('assets/inc/config.php');
        ...
        
        {
			...
			$query="UPDATE  his_equipments SET  eqp_name = ?, eqp_vendor = ?, eqp_desc = ?, eqp_dept = ?, eqp_status = ? WHERE eqp_code = ?";
			$stmt = $mysqli->prepare($query);
			$rc=$stmt->bind_param('ssssss',  $eqp_name, $eqp_vendor, $eqp_desc, $eqp_dept, $eqp_status, $eqp_code);
			$stmt->execute();
			/*

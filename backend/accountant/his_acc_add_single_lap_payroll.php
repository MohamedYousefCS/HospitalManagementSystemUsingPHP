    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <?php
                ...
                $ret="SELECT  * FROM his_lap_emp WHERE lap_number=?";
                $stmt= $mysqli->prepare($ret) ;
                $stmt->bind_param('s',$lap_number);
                $stmt->execute() ;//ok
                $res=$stmt->get_result();
                //$cnt=1;
                                            ...
                                            <form method="post">
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        ...
                                                        <input type="text" required="required" readonly name="pay_doc_name" value="<?php echo $row->lap_fname;?> <?php echo $row->lap_lname;?>" class="form-control" id="inputEmail4" placeholder="Patient's Name">
                                                    </div>

                                                    <div class="form-group col-md-4">
                                                        <label for="inputPassword4" class="col-form-label">Employee Email</label>
                                                        <input required="required" type="text" readonly name="pay_doc_email" value="<?php echo $row->lap_email;?>" class="form-control"  id="inputPassword4" placeholder="Patient`s Last Name">
                                                    </div>

                                                    <div class="form-group col-md-4">
                                                        <label for="inputPassword4" class="col-form-label">Employee Number</label>
                                                        <input required="required" type="text" readonly name="pay_doc_number" value="<?php echo $row->lap_number;?>" class="form-control"  id="inputPassword4" placeholder="Patient`s Last Name">
                                                    </div>

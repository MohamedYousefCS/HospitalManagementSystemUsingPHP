                                        ...
                                        <form method="post">
                                            <div class="form-row">
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <input type="text" required="required" value="<?php echo $row->Fname;?> <?php echo $row->Lname;?>" name="t_pat_name" class="form-control" id="inputEmail4" placeholder="Patient's First Name">
                                                </div>

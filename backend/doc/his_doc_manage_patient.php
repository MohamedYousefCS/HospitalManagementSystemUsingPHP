                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                       <!-- <a href="his_admin_manage_patient.php?delete=<?php echo $row->id;?>" class="badge badge-danger"><i class=" mdi mdi-trash-can-outline "></i> Delete</a>-->
                                                        <a href="his_doc_view_single_patient.php?pat_id=<?php echo $row->id;?>&&pat_number=<?php echo $row->pat_number;?>" class="badge badge-success"><i class="mdi mdi-eye"></i> View</a>

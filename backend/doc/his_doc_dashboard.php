                                        ...
                                        <table dir="rtl" class="table table-borderless table-hover table-centered m-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="his_doc_view_single_patient.php?pat_id=<?php echo $row->id;?>&&pat_number=<?php echo $row->pat_number;?>&&pat_name=<?php echo $row->Fname;?>_<?php echo $row->Lname;?>" class="btn btn-xs btn-success"><i class="mdi mdi-eye"></i> View</a>
                                                    </td>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   
                                                </tr>
                                            </tbody>
                                            <?php }?>

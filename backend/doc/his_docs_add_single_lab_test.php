...
<?php
	...
	include('assets/inc/config.php');
		if(isset($_POST['add_patient_lab_test']))
		{
			...
			$query="INSERT INTO  his_laboratory  (lab_pat_name, lab_pat_number, lab_pat_tests, lab_number ) VALUES(?,?,?,?)";
			$stmt = $mysqli->prepare($query);
			$rc=$stmt->bind_param('ssss', $lab_pat_name, $lab_pat_number, $lab_pat_tests, $lab_number);
			$stmt->execute();
			/*
                                            ...
                                            <form method="post">
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-12">
                                                        ...
                                                        <input type="text" required="required" readonly name="lab_pat_name" value="<?php echo $row->Fname;?> <?php echo $row->Lname;?>" class="form-control" id="inputEmail4" placeholder="Patient's First Name">
                                                    </div>
                                                ...
                                                <button type="submit" name="add_patient_lab_test" class="ladda-button btn btn-success" data-style="expand-right">Add Test</button>

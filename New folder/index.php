...
<!-- counter section ends -->
  ...
  <div class="page-section">
    <div class="container">
      ...
      <form class="main-form text-right" dir="rtl" method="post" action="contact.php">
        <div class="row mt-5 ">
          <div class="col-12 col-sm-6 py-2 wow fadeInLeft">
            <input type="text" name="full_name" class="form-control" placeholder="الاسم بالكامل">
          </div>
          <div class="col-12 col-sm-6 py-2 wow fadeInRight">
            <input type="email" name="email" class="form-control" placeholder="الايميل الشخصي">
          </div>
          <div class="col-12 col-sm-6 py-2 wow fadeInLeft" data-wow-delay="300ms">
            <input type="date" name="his_date" class="form-control">
          </div>
        ...
        <button type="btnSubmit" class=" btn btn-primary mt-3 wow zoomIn">تاكيد الحجز </button>
      </form>
    </div>
  </div>
   <!-- .page-section -->
